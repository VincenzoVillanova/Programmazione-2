...
public:
    ...
    void CalcolaAltezza(BSTNode<T> *ptr)
    {
        if (ptr == nullptr)
            return;

        CalcolaAltezza(ptr->left);
        CalcolaAltezza(ptr->right);
        s << CalcolaAltezza1(ptr) - 1 << " ";
    }

    int CalcolaAltezza1(BSTNode<T> *ptr)
    {
        int destra, sinistra;
        if (ptr == nullptr)
        {
        ...
        sinistra = CalcolaAltezza1(ptr->left);
        destra = CalcolaAltezza1(ptr->right);
        if (sinistra > destra)
        {
            return sinistra + 1;
        }
